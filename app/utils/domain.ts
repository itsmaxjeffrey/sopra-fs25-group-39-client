 ...
 * In development, it returns the development URL.
 */
export function getApiDomain(): string {
  const prodUrl = process.env.NEXT_PUBLIC_PROD_API_URL ||
    "https://sopra-fs25-group-39-server.oa.r.appspot.com"; // TODO: update with your production URL as needed.
  const devUrl = "http://localhost:8080"; // Keep localhost for local dev
