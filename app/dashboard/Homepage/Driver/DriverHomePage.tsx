...
const HomePage = () => {
  ...
  const [pendingOffersLoading, setPendingOffersLoading] = useState<boolean>(true); // Start loading true
  ...
  useEffect(() => {
    const fetchPendingOffers = async () => {
      ...
      try {
        ...
        const res = await axios.get<{ offers: Offer[] }>(`${BASE_URL}/api/v1/users/${userId}/offers`, {
          headers: {
            UserId: userId,
            Authorization: token,
          },
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column" }}>
      <div style={{ flexGrow: 1, position: "relative", height: mapContainerStyle.height }}>
        {/* Map Component */}
        <DriverMap
      ...
      <Drawer
        ...
        footer={ // Add footer for explicit actions
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '10px' }}>
            ...
            <Checkbox
              ...
              onChange={(e) => updateFilter("coolingRequired", e.target.checked)}
            >
              Cooling Required
            </Checkbox>
            <Checkbox
      ...
      <div style={{ height: '200px', overflowY: 'auto', display: 'flex', flexDirection: 'column', background: '#f0f2f5', padding: '10px 20px' }}>
                  ...
                  <Link href={`/dashboard/proposal/${offer.contract.contractId}?type=OFFERED`}>
                    ...
                    >
                      ...
                      <p style={{ whiteSpace: 'normal' }}>
                        <EnvironmentOutlined /> {offer.contract.fromLocation?.formattedAddress || "N/A"} ➝{" "}
                ...
                <List.Item>
                  <Link href={`/dashboard/proposal/${contract.contractId}?type=${contract.contractStatus}`}>
                    ...
                    >
                      ...
                      <p style={{ whiteSpace: 'normal' }}>
                        <EnvironmentOutlined /> {contract.fromLocation?.formattedAddress || "N/A"} ➝{" "}
